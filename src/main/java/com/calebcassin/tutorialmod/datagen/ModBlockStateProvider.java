...
import com.calebcassin.tutorialmod.block.custom.BismuthLampBlock;
...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void blockItem(DeferredBlock<?> deferredBlock) {
        simpleBlockItem(deferredBlock.get(), new ModelFile.UncheckedModelFile("ccassinnftutorial:block/" + deferredBlock.getId().getPath()));
    }

    private void blockItem(DeferredBlock<?> deferredBlock, String appendix) {
        simpleBlockItem(deferredBlock.get(), new ModelFile.UncheckedModelFile("ccassinnftutorial:block/" + deferredBlock.getId().getPath() + appendix));
    }
}
