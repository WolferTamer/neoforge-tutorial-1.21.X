package com.calebcassin.tutorialmod.datagen;

import com.calebcassin.tutorialmod.TutorialMod;
import com.calebcassin.tutorialmod.block.ModBlocks;
import com.calebcassin.tutorialmod.item.ModItems;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        List<ItemLike> BISMUTH_SMELTABLES = List.of(ModItems.RAW_BISMUTH.get(), ModBlocks.BISMUTH_ORE, ModBlocks.BISMUTH_DEEPSLATE_ORE);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.BISMUTH.get(), 18)
                ...
                .save(recipeOutput, "ccassinnftutorial:bismuth_from_magic_block");
        ...
        stairBuilder(ModBlocks.BISMUTH_STAIRS, Ingredient.of(ModItems.BISMUTH)).group("bismuth")
                .unlockedBy("has_bismuth", has(ModItems.BISMUTH)).save(recipeOutput);

        slab(recipeOutput, RecipeCategory.BUILDING_BLOCKS, ModBlocks.BISMUTH_SLAB, ModItems.BISMUTH.get());
