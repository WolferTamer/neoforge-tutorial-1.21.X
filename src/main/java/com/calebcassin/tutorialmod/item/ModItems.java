package com.calebcassin.tutorialmod.item;

import com.calebcassin.tutorialmod.TutorialMod;
import com.calebcassin.tutorialmod.item.custom.ChiselItem;
import com.calebcassin.tutorialmod.item.custom.FuelItem;
import com.calebcassin.tutorialmod.item.custom.HammerItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> CHISEL = ITEMS.register("chisel", () -> new ChiselItem(new Item.Properties().durability(128)));
    ...
    public static final DeferredItem<Item> RADISH = ITEMS.register("radish", () -> new Item(new Item.Properties().food(ModFoodProperties.RADISH)) {
        ...
        public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
            tooltipComponents.add(Component.translatable("tooltip.ccassinnftutorial.radish.tooltip"));
